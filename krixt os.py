...
class Window(QMainWindow,QWidget):
    def __init__(self):
        ...
        self.cb.setStyleSheet("background-image : url(calcmedlogov6.png); border : none")
        self.bb.setStyleSheet("background-image : url(kiconv3.png); border : none")
        self.uih.setStyleSheet("background-image : url(rbg3.png)")
        self.opacity_effect = QGraphicsOpacityEffect()
        self.opacity_effect.setOpacity(0.7)
        self.uih.setGraphicsEffect(self.opacity_effect)
        self.container.setStyleSheet("background-image : url(rbg3.png)")
        self.btn_close.setStyleSheet("background-image : url(sxc.png); border : none ")
        self.btn_9.setStyleSheet("background-image : url(9c.png); border : none")
        self.btn_8.setStyleSheet("background-image : url(8c.png); border : none")
        self.btn_7.setStyleSheet("background-image : url(7c.png); border : none")
        self.btn_6.setStyleSheet("background-image : url(6c.png); border : none")
        self.btn_5.setStyleSheet("background-image : url(5c.png); border : none")
        self.btn_4.setStyleSheet("background-image : url(4c.png); border : none")
        self.btn_3.setStyleSheet("background-image : url(3c.png); border : none")
        self.btn_2.setStyleSheet("background-image : url(2c.png); border : none")
        self.btn_1.setStyleSheet("background-image : url(1c.png); border : none")
        self.btn_0.setStyleSheet("background-image : url(0c.png); border : none")
        self.btn_plus.setStyleSheet("background-image : url(pc.png); border : none") 
        self.btn_mins.setStyleSheet("background-image : url(mc.png); border : none") 
        self.btn_mult.setStyleSheet("background-image : url(xc.png); border : none") 
        self.btn_divd.setStyleSheet("background-image : url(dc.png); border : none") 
        self.btn_result.setStyleSheet("background-image : url(ec.png); border : none") 
        self.btn_clear.setStyleSheet("background-image : url(rc.png); border : none")
        ...
        self.showMaximized()
        #self.showFullScreen()
        self.setStyleSheet("background-image : url(Krixtbg.png);")
